...
class Ui_FocusInterface(object):
	def setupUi(self, FocusInterface):
		...
		icon = QIcon()
		icon.addFile(":/images/tips.png", QSize(), QIcon.Normal, QIcon.Off)
		self.progressIcon.setIcon(icon)

		self.horizontalLayout_4.addWidget(self.progressIcon)

		self.horizontalSpacer_8 = QSpacerItem(
			2, 20, QSizePolicy.Fixed, QSizePolicy.Minimum
		)
		...
		self.verticalLayout_5.addWidget(
			self.minuteLabel1, 0, Qt.AlignHCenter | Qt.AlignVCenter
		)
		...
		sizePolicy1.setHeightForWidth(
			self.progressRing.sizePolicy().hasHeightForWidth()
		)
		...
		self.verticalSpacer_16 = QSpacerItem(
			20, 3, QSizePolicy.Minimum, QSizePolicy.Fixed
		)
		...
		self.verticalLayout_6.addWidget(
			self.continousComplianceDayLabel, 0, Qt.AlignHCenter | Qt.AlignVCenter
		)
		...
		icon1 = QIcon()
		icon1.addFile(":/images/alarms.png", QSize(), QIcon.Normal, QIcon.Off)
		...
		icon2 = QIcon()
		icon2.addFile(":/images/todo.png", QSize(), QIcon.Normal, QIcon.Off)
		self.taskCardIcon.setIcon(icon2)

		self.horizontalLayout_7.addWidget(self.taskCardIcon)

		self.horizontalSpacer_7 = QSpacerItem(
			2, 2, QSizePolicy.Fixed, QSizePolicy.Minimum
		)
	...
	def retranslateUi(self, FocusInterface):
		FocusInterface.setWindowTitle(
			QCoreApplication.translate("FocusInterface", "Form", None)
		)
		self.dailyProgressLabel.setText(
			QCoreApplication.translate(
				"FocusInterface", "\u6bcf\u65e5\u8fdb\u5ea6", None
			)
		)
		self.yesterdayLabel.setText(
			QCoreApplication.translate("FocusInterface", "\u6628\u5929", None)
		)
		self.yesterdayTimeLabel.setText(
			QCoreApplication.translate("FocusInterface", "3", None)
		)
		self.minuteLabel1.setText(
			QCoreApplication.translate("FocusInterface", "\u5206\u949f", None)
		)
		self.targetLabel.setText(
			QCoreApplication.translate(
				"FocusInterface", "\u4eca\u65e5\u8ba1\u5212", None
			)
		)
		self.progressRing.setFormat(
			QCoreApplication.translate(
				"FocusInterface", "\u76ee\u6807 %v \u5c0f\u65f6", None
			)
		)
		self.finishTimeLabel.setText(
			QCoreApplication.translate(
				"FocusInterface", "\u5df2\u5b8c\u6210\uff1a0 \u5206\u949f", None
			)
		)
		self.continousComplianceDayLabel.setText(
			QCoreApplication.translate(
				"FocusInterface", "\u8fde\u7eed\u8fbe\u6807\u65e5", None
			)
		)
		self.compianceDayLabel.setText(
			QCoreApplication.translate("FocusInterface", "5", None)
		)
		self.dayLabel.setText(
			QCoreApplication.translate("FocusInterface", "\u5929", None)
		)
		self.focusPeriodLabel.setText(
			QCoreApplication.translate(
				"FocusInterface", "\u4e13\u6ce8\u65f6\u6bb5", None
			)
		)
		self.prepareFocusLabel.setText(
			QCoreApplication.translate(
				"FocusInterface", "\u51c6\u5907\u4e13\u6ce8", None
			)
		)
		self.hintLabel.setText(
			QCoreApplication.translate(
				"FocusInterface",
				"\u6211\u4eec\u5c06\u5728\u6bcf\u4e2a\u4f1a\u8bdd\u671f\u95f4\u5173\u95ed\u901a\u77e5\u548c\u5e94\u7528\u8b66\u62a5\u3002\u5bf9\u4e8e\u8f83\u957f\u7684\u4f1a\u8bdd\uff0c\u6211\u4eec\u5c06\u6dfb\u52a0\u7b80\u77ed\u7684\u4f11\u606f\u65f6\u95f4\uff0c\u4ee5\u4fbf\u4f60\u53ef\u4ee5\u6062\u590d\u7cbe\u529b\u3002",
				None,
			)
		)
		...
		self.skipRelaxCheckBox.setText(
			QCoreApplication.translate(
				"FocusInterface", "\u8df3\u8fc7\u4f11\u606f", None
			)
		)
		self.startFocusButton.setText(
			QCoreApplication.translate(
				"FocusInterface", "\u542f\u52a8\u4e13\u6ce8\u65f6\u6bb5", None
			)
		)
		self.taskLabel.setText(
			QCoreApplication.translate("FocusInterface", "\u4efb\u52a1", None)
		)
		self.hintLabel_2.setText(
			QCoreApplication.translate(
				"FocusInterface", "\u4e3a\u4f1a\u8bdd\u9009\u62e9\u4efb\u52a1", None
			)
		)
		self.taskLabel1.setText(
			QCoreApplication.translate(
				"FocusInterface",
				"\u5168\u519b\u51fa\u9e21\uff0c\u8a93\u6b7b\u4fdd\u536b\u9e3d\u9e3d\uff01\uff01",
				None,
		...
		self.taskLabel3.setText(
			QCoreApplication.translate(
				"FocusInterface",
				"\u4e0b\u8f7d\u6211\u5bb6 aiko \u7684\u65b0\u6b4c\u300e\u8352\u308c\u305f\u5507\u306f\u604b\u3092\u5931\u304f\u3059\u300f",
				None,
			)
		)
