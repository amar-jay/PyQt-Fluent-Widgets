...
class Ui_StopWatchInterface(object):
	def setupUi(self, StopWatchInterface):
		...
		self.horizontalSpacer_7 = QSpacerItem(
			90, 17, QSizePolicy.Fixed, QSizePolicy.Minimum
		)
	...
	def retranslateUi(self, StopWatchInterface):
		StopWatchInterface.setWindowTitle(
			QCoreApplication.translate("StopWatchInterface", "Form", None)
		)
		self.timeLabel.setText(
			QCoreApplication.translate("StopWatchInterface", "00:00:00", None)
		)
		self.hourLabel.setText(
			QCoreApplication.translate("StopWatchInterface", "\u5c0f\u65f6", None)
		)
		self.minuteLabel.setText(
			QCoreApplication.translate("StopWatchInterface", "\u5206\u949f", None)
		)
		self.secondLabel.setText(
			QCoreApplication.translate("StopWatchInterface", "\u79d2", None)
		)
