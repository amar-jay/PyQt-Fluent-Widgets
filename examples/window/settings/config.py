...
class Config(QConfig):
	...
	onlineSongQuality = OptionsConfigItem(
		...
		OptionsValidator(SongQuality),
		EnumSerializer(SongQuality),
	)
	...
	deskLyricStrokeColor = ColorConfigItem("DesktopLyric", "StrokeColor", Qt.black)
	deskLyricFontFamily = ConfigItem("DesktopLyric", "FontFamily", "Microsoft YaHei")
	deskLyricAlignment = OptionsConfigItem(
		"DesktopLyric",
		"Alignment",
		"Center",
		OptionsValidator(["Center", "Left", "Right"]),
	)
