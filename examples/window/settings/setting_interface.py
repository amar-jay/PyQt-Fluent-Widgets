...
from PySide6.QtWidgets import QFileDialog, QFontDialog, QLabel, QWidget
...
class SettingInterface(ScrollArea):
	...
	def __init__(self, parent=None):
		...
		self.onlineMusicQualityCard = OptionsSettingCard(
			...
			texts=[
				self.tr("Standard quality"),
				self.tr("High quality"),
				self.tr("Super quality"),
				self.tr("Lossless quality"),
			],
			parent=self.onlineMusicGroup,
		)
		...
		self.deskLyricAlignmentCard = OptionsSettingCard(
			...
			self.tr("Alignment"),
			texts=[
				self.tr("Center aligned"),
				self.tr("Left aligned"),
	...
	def __connectSignalToSlot(self):
		...
		# music in the pc
		self.musicFolderCard.folderChanged.connect(self.musicFoldersChanged)
